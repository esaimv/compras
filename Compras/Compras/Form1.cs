...
namespace Compras
{
    public partial class Form1 : Form
    {
        ...
        private void pedidosToolStripMenuItem_DropDownClosed(object sender, EventArgs e)
        {
        ...
        private void pedidosToolStripMenuItem_DropDownOpened(object sender, EventArgs e)
        {
            pedidosToolStripMenuItem.ForeColor = Color.Black;
        }

        private void facturaToolStripMenuItem_DropDownClosed(object sender, EventArgs e)
        {
            facturaToolStripMenuItem.ForeColor = Color.White;
        }

        private void facturaToolStripMenuItem_DropDownOpened(object sender, EventArgs e)
        {
            facturaToolStripMenuItem.ForeColor = Color.Black;
        }

        private void proveedoresToolStripMenuItem_DropDownClosed(object sender, EventArgs e)
        {
            proveedoresToolStripMenuItem.ForeColor = Color.White;
        }

        private void proveedoresToolStripMenuItem_DropDownOpened(object sender, EventArgs e)
        {
            proveedoresToolStripMenuItem.ForeColor = Color.Black;
        }
    }
}
