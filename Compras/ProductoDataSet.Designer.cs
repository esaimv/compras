...
namespace Compras.ProductoDataSetTableAdapters {
    ...
    public partial class PRODUCTOTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[PRODUCTO] WHERE (([id_producto] = @Original_id_producto) AND ((@IsNull_descripcion = 1 AND [descripcion] IS NULL) OR ([descripcion] = @Original_descripcion)) AND ((@IsNull_tipo = 1 AND [tipo] IS NULL) OR ([tipo] = @Original_tipo)) AND ((@IsNull_stock = 1 AND [stock] IS NULL) OR ([stock] = @Original_stock)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[PRODUCTO] SET [id_producto] = @id_producto, [descripcion] = @descripcion, [tipo] = @tipo, [stock] = @stock WHERE (([id_producto] = @Original_id_producto) AND ((@IsNull_descripcion = 1 AND [descripcion] IS NULL) OR ([descripcion] = @Original_descripcion)) AND ((@IsNull_tipo = 1 AND [tipo] IS NULL) OR ([tipo] = @Original_tipo)) AND ((@IsNull_stock = 1 AND [stock] IS NULL) OR ([stock] = @Original_stock)));
SELECT id_producto, descripcion, tipo, stock FROM PRODUCTO WHERE (id_producto = @id_producto)";
        ...
        public virtual int Delete(int Original_id_producto, string Original_descripcion, string Original_tipo, global::System.Nullable<int> Original_stock) {
        ...
        public virtual int Insert(int id_producto, string descripcion, string tipo, global::System.Nullable<int> stock) {
        ...
        public virtual int Update(int id_producto, string descripcion, string tipo, global::System.Nullable<int> stock, int Original_id_producto, string Original_descripcion, string Original_tipo, global::System.Nullable<int> Original_stock) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string descripcion, string tipo, global::System.Nullable<int> stock, int Original_id_producto, string Original_descripcion, string Original_tipo, global::System.Nullable<int> Original_stock) {
